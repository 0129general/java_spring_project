...
public class ApplicationConstants {
	...
	public final static String RECAPTCHA_URL = "react_native.recapatcha_url";
	public final static String RECAPTCHA_PRIVATE_KEY = "react_native.recapatcha_private_key";
	public final static String RECAPTCHA_PUBLIC_KEY = "react_native.recapatcha_public_key";
