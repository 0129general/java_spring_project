...
public class ApplicationConstants {
	...
	public final static String RECAPTCHA_URL = "java_spring.recapatcha_url";
	public final static String RECAPTCHA_PRIVATE_KEY = "java_spring.recapatcha_private_key";
	public final static String RECAPTCHA_PUBLIC_KEY = "java_spring.recapatcha_public_key";
